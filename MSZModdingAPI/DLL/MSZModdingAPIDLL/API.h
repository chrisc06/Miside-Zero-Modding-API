...
namespace MSZ_API {
    ...
    namespace Unity {
        ...
        MSZ_API_FUNC bool GetKey(KeyCode key);
        MSZ_API_FUNC bool GetKeyDown(KeyCode key);
        MSZ_API_FUNC bool GetKeyUp(KeyCode key);
        MSZ_API_FUNC bool GetButton(const char* name);
        MSZ_API_FUNC bool GetButtonDown(const char* name);
        MSZ_API_FUNC bool GetButtonUp(const char* name);
        MSZ_API_FUNC bool GetMouseButton(int button);
        MSZ_API_FUNC bool GetMouseButtonDown(int button);
        MSZ_API_FUNC bool GetMouseButtonUp(int button);
    }
